...
![](images/clipboard-473652887.png){fig-align="center" width="526"}
...
En las semanas analizadas, se notificaron un total de `r varicela_SEBEM` casos de varicela a nivel provincial. La variación porcentual es del `r IP_variacion_porcentual` % con respecto al mismo periodo del año anterior.
