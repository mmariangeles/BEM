...
Por último, en relación a la variable sexo, la misma se imputa a partir de los datos provenientes del Re-

gistro Nacional de las Personas (ReNaPer). El tipo de registros disponibles no posibilita aún incorporar la noción de género.
...
grid.draw(indicador_accidentes)
